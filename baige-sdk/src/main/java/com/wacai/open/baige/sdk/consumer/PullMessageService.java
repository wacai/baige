...
public class PullMessageService {
    ...
    public PullMessageService(MQClientInstance mqClientInstance, PullRequest pullRequest, long pullIntervalMs,
        int pullThreadsNum) {
    ...
    public void resume() {
        for (PullMessageAtomService pullMessageAtomService : pullMessageAtomServiceList) {
            pullMessageAtomService.isSuspendForLongPolling.set(false);
            ...
            if (mqConsumerInner != null) {
                mqConsumerInner.doPullMessage(pullRequest, new PullMsgCallback() {
                    ...
                    public void onSuccess(PullResult pullResult) {
                        ...
                        LOGGER.info("PullMessageAtomService_{} set pull msg interval to {} ms, Reason:Msg found", index,
                            pullIntervalMs);
                    ...
                    public void onMsgNotFound(PullRequest pullRequest) {
                        if (isSuspendForLongPolling.compareAndSet(false, true)) {
                            try {
                                ...
                                LOGGER.info("suspend {} ms for long polling {},  reason is msg not found", suspendMs,
                                    pullRequest);
                                suspend(suspendMs);
